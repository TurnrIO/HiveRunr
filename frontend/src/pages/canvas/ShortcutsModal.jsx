...
const CANVAS_SHORTCUTS = [
  ...
  { key: "Right-click node",  desc: "Context menu (copy ID, rename, duplicate, delete)" },
  ...
  { key: "Click + drag",     desc: "Pan the canvas" },
  { key: "Ctrl + drag node", desc: "Move node without snapping" },
  { section: "Other" },
